...
<style>
    ...
    function search1(){
        //폼값 밸리데이션
        if( !jsonFormValid(obj_condition_valid.F_SITEID, "F_SITEID", "사이트ID", $("#F_SITEID").val()) ){return false;};
        //if( !jsonFormValid(obj_condition_valid.F_PGMID, "F_", "프로그램ID", $("#F_PGMID").val()) ){return false;};
    ...
    function addRow1(){
        ...
        var id=mygrid1.uid();
        mygrid1.addRow(id,["",$("#F_SITEID").val(),"","","",""],0);
        mygrid1.showRow(id);
        mygrid1.selectRow(0);
    ...
    function addRow2(){
        ...
        var id=mygrid2.uid();
        mygrid2.addRow(id,["",$("#F_SITEID").val(),"","","",""],0);
        mygrid2.showRow(id);
        mygrid2.selectRow(0);
    ...
    var mygrid1_url = "bc_url_crud.php?F_GRPID=1&";
    var mygrid2_url = "bc_url_crud.php?F_GRPID=2&";
    ...
    var obj_condition_valid = jQuery.parseJSON( '{"__NAME":"obj_condition_valid"' +
        ' ,"F_SITEID": {"REQUARED":"Y",  "MIN":"0",  "MAX":"ZZZ",  "DATASIZE":10,  "DATATYPE":"STRING"} ' +
        ' ,"F_SCANURL": {"REQUARED":"Y",  "MIN":"0",  "MAX":"ZZZ",  "DATASIZE":10,  "DATATYPE":"STRING"} ' +
        '}');
    ...
    function initBody(){
        ...
        mygrid1.setHeader("URLSEQ,SITEID,SCANORD,PURLSEQ,URLDESC,PORT,SCANURL,REFERER,FORMTYPE,ADDDT,MODDT");
        mygrid1.setColumnIds("URLSEQ,SITEID,SCANORD,PURLSEQ,URLDESC,PORT,SCANURL,REFERER,FORMTYPE,ADDDT,MODDT");
        //mygrid1.attachHeader("#connector_text_filter,#connector_text_filter,#connector_text_filter,#connector_text_filter")
        mygrid1.setInitWidths("50,50,50,50,80,50,250,250,80,80,80")
        mygrid1.setColTypes("ro,ed,ed,ed,ed,ed,ed,ed,ed,ro,ro");
        ...
        mygrid2.setHeader("PARAMSEQ,SITEID,PARAMORD,NAME,ADDDT,MODDT");
        mygrid2.setColumnIds("PARAMSEQ,SITEID,PARAMORD,PARAMNAME,ADDDT,MODDT");
        //mygrid2.attachHeader("#connector_text_filter,#connector_text_filter,#connector_text_filter,#connector_text_filter")
        mygrid2.setInitWidths("80,80,80,80,80,80")
        mygrid2.setColTypes("ro,ed,ed,ed,ro,ro");
        mygrid2.setColAlign("left,left,left,left,left,left")
        ...
        <div style="position: relative;background-color:#eeeeee;padding:5px 5px 5px 5px;overflow:auto;">
            ...
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    ...
                    <div class="CON_OBJECT" style="width:150px;"><input type="text" name="F_SITEID" value="" id="F_SITEID"></div>
                </div>
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">PGMID</div>
                    <div class="CON_OBJECT" style="width:150px;"><input type="text" name="F_SCANURL" value="" id="F_SCANURL"></div>
                </div>
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">PGMNM</div>
                    <div class="CON_OBJECT" style="width:150px;"><input type="text" name="F_URLDESC" value="" id="F_URLDESC"></div>
                </div>
            </div>
    ...
    <div class="GRP_LINE" >
        <div class="GRP_OBJECT" style="width:100%;">
            ...
            <div style="position: relative;width:100%;padding:0 0 0 0;z-index:20;">
                <div id="grid1" width="100%" height="120px" style="background-color:white;z-index:30;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="GRP_LINE" >
        <div class="GRP_OBJECT" style="width:100%;">
            ...
            <div style="position: relative;width:100%;padding:0 0 0 0;z-index:30;">
                <div id="grid2" width="100%" height="400px" style="background-color:white;z-index:40;"></div>
            </div>
        </div>
