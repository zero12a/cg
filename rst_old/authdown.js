//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "authdownController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "authdownController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "authdownController.php?CTLGRP=G1&CTLFNC=RESET";//조회조건 변수 선언	
...
//컨트롤러 경로
var url_G2_SEARCH = "authdownController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_RELOAD = "authdownController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "authdownController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "authdownController.php?CTLGRP=G2&CTLFNC=EXCEL";
//그리드 객체
  ...
  alog("G2_INIT()-------------------------start");
	...
	//가로 정렬
		...
		mygridG2.attachEvent("onKeyPress",function(code,ctrl,shift){
			alog("onKeyPress()......code=" +  code + ", ctrl=" + ctrl);
			//셀편집모드 아닐때만 블록처리
			if(!mygridG2.editor){
				alog("editor....on");
