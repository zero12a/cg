//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "groupmngController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "groupmngController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "groupmngController.php?CTLGRP=G1&CTLFNC=RESET";//조회조건 변수 선언	
var obj_G1_GRP_SEQ_valid = jQuery.parseJSON( '{ "G1_GRP_SEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );  //GRP_SEQ  밸리데이션
var obj_G1_GRP_NM_valid = jQuery.parseJSON( '{ "G1_GRP_NM": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );  //GRP_NM  밸리데이션
var obj_G1_GRP_SEQ; // GRP_SEQ 변수선언var obj_G1_GRP_NM; // GRP_NM 변수선언//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "groupmngController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "groupmngController.php?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_ROWDELETE = "groupmngController.php?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWADD = "groupmngController.php?CTLGRP=G2&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G2_RELOAD = "groupmngController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "groupmngController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "groupmngController.php?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "groupmngController.php?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//디테일 변수 초기화	

//폼뷰 컨트롤러 경로
var url_G3_SEARCH = "groupmngController.php?CTLGRP=G3&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_G3_SAVE = "groupmngController.php?CTLGRP=G3&CTLFNC=SAVE";
//폼뷰 컨트롤러 경로
var url_G3_RELOAD = "groupmngController.php?CTLGRP=G3&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_G3_NEW = "groupmngController.php?CTLGRP=G3&CTLFNC=NEW";
//폼뷰 컨트롤러 경로
var url_G3_MODIFY = "groupmngController.php?CTLGRP=G3&CTLFNC=MODIFY";
//폼뷰 컨트롤러 경로
var url_G3_DELETE = "groupmngController.php?CTLGRP=G3&CTLFNC=DELETE";
//화면 초기화
function initBody(){
     alog("initBody()-----------------------start");
  ...
  alog("G2_INIT()-------------------------start");
	...
	//onCheck
		...
		//A124
			...
			'}');
			G3_SEARCH(lastinputG3); //자식그룹 호출 : 그룹상세
		});
    ...
    function G2_SEARCH(tinput){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[그룹목록] Ajax http 500 error ( " + error + " )");
            }
        });
