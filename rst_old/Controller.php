...
alog("Control___________________________start");
...
}else if($objAuth->isAuth("",$ctl)){
	$objAuth->LAUTH_SEQ = $objAuth->logUsrAuth($reqToken,$resToken,"",$ctl,"Y");
}else{
	$objAuth->logUsrAuth($reqToken,$resToken,"",$ctl,"N");
...
alog("Control___________________________end");
