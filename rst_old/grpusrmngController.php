...
include_once('grpusrmngService.php');
...
alog("GrpusrmngControl___________________________start");
...
$REQ["G1-GRP_SEQ"] = getFilter($REQ["G1-GRP_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-USR_SEQ"] = getFilter($REQ["G3-USR_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G4-USR_SEQ"] = getFilter($REQ["G4-USR_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-CHK"] = filterGridChk($REQ["G3-CHK"],"NUMBER",10,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//USR_SEQ 입력값검증
	$REQ["G4-CHK"] = $_POST["G4-CHK"];//CHK 받기
//filterGridChk($tStr,$tDataType,$tDataSize,$tValidType,$tValidRule)
$REQ["G4-CHK"] = filterGridChk($REQ["G4-CHK"],"NUMBER",10,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//USR_SEQ 입력값검증
...
alog("GrpusrmngControl___________________________end");
