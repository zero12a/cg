...
$REQ["C1-PJTSEQ"] = getFilter($REQ["C1-PJTSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	

//G2, 목록
$REQ["G2-VALIDSEQ"] = reqPostNumber("G2-VALIDSEQ",30);//VALIDSEQ	
$REQ["G2-VALIDSEQ"] = getFilter($REQ["G2-VALIDSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-PJTSEQ"] = reqPostNumber("G2-PJTSEQ",20);//PJTSEQ	
$REQ["G2-PJTSEQ"] = getFilter($REQ["G2-PJTSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G2-VALIDORD"] = getFilter($REQ["G2-VALIDORD"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G2-CHK"] = filterGridChk($REQ["G2-CHK"],"NUMBER",30,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//VALIDSEQ 입력값검증
