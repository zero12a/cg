...
<head>
    ...
    function clearRowChanged(tgrid,trid){
        console.log("clearRowChanged----------------------------start");
        console.log("       tgrid.getColumnCount : " + tgrid.getColumnCount());
        ...
        console.log("clearRowChanged----------------------------end");
    }
    ...
    //정적 변수 선언
    var myCalendar;
    var mygrid1,selrowid1,lastinput1;
    var mygrid2,selrowid2,lastinput2;
    var mygrid3,selrowid3,lastinput3;
    var mygrid4,selrowid3,lastinput4;
    var url_1 = "cg_objinfo_crud.php?F_GRPID=1&";
    var url_2 = "cg_objinfo_crud.php?F_GRPID=2&";
    var url_3 = "cg_objinfo_crud.php?F_GRPID=3&";
    var url_4 = "cg_objinfo_crud.php?F_GRPID=4&";
    ...
    function initBody(){
        ...
        console.log("       grid2 init-----------end");

        mygrid3 = new dhtmlXGridObject('grid3');
        mygrid3.setImagePath("../dhtmlx/imgs/");
        mygrid3.setHeader("SEQ,OBJTYPE,ORD,OBJDESC,SRCTXT,SPT,INPUT,PARAM,TYPE,ADDDT,MODDT");
        mygrid3.setColumnIds("OBJASEQ,OBJTYPE,OBJAORD,OBJDESC,SRCTXT,SPTTXT,INPUT,PARAM,SRCTYPE,ADDDT,MODDT");
        //mygrd3.attachHeader("#connector_text_filter,#connector_text_filter,#connector_text_filter,#connector_text_filter")
        mygrid3.setInitWidths("50,50,50,80,500,30,80,80,50,70,70")
        mygrid3.setColTypes("ro,ed,ed,ed,txttxt,ed,ed,ed,ed,ro,ro");
        mygrid3.setColAlign("left,left,left,left,left,left,left,left,left,left,right")
        //mygrid2.isColumnHidden(0);//PJTID숨기기
    ...
    function detailNew4(){
        console.log("DetailNew4()-----------------------start");

        console.log("       form_F4 serial : " + $("#form_F4").serialize());
    ...
    function detailSearch4(tinput){
        console.log("DetailSearch4()------------start");
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                console.log("   json RTN_DATA  : " + data.RTN_DATA);
        ...
        addstatusyn2 = false;
        console.log("DetailSearch4()------------end");

    }
    function detailSave4(){

        console.log("DetailSave4()------------start");
        //serialize user data or not,
        //serialize 'selected' attribute for the rows tags,
        //serialize grid structure info,
        //serialize the 'changed' attribute for the cells tags,
...
<div id="BODY_BOX" class="BODY_BOX">
    ...
    <div class="GRP_LINE" >
        <div class="GRP_OBJECT" style="width:55%;height:330px">
            <div style="position: relative;width:100%;padding:0 0 0 0;text-align:right;">
            ...
            <div id="grid1" width="100%"  style="height:295px;background-color:white;overflow:hidden"></div>
            </div>
        </div>
        <div class="GRP_OBJECT" style="width:45%;height:330px">
            <div style="width:0px;height:0px;overflow: hidden"><form id="form_F4"><input type="hidden" id="F4_CRUD_MODE" value="new"></div>

            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">OBJTYPE *</div>
                    <div class="CON_OBJECT" style="width:400px;"><input type="text" id="F4_OBJTYPE" style="width:100%;"></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">STARTTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><textarea id="F4_STARTTXT" style="width:100%;height:44px;"></textarea></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">LBLSTARTTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><textarea id="F4_LBLSTARTTXT" style="width:100%;height:44px;"></textarea></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">LBLTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><input type="text" id="F4_LBLTXT" style="width:100%;"></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">LBLENDTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><input type="text" id="F4_LBLENDTXT" style="width:100%;"></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">OBJSTARTTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><textarea id="F4_OBJSTARTTXT" style="width:100%;height:44px;"></textarea></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">OBJTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><textarea id="F4_OBJTXT" style="width:100%;height:44px;"></textarea></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">OBJENDTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><input type="text" id="F4_OBJENDTXT"style="width:100%;"></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">ENDTXT</div>
                    <div class="CON_OBJECT" style="width:400px;"><input type="text" id="F4_ENDTXT"style="width:100%;"></div>
                </div>
            </div>
            <div class="CON_LINE" style="">
                <div class="CON_OBJGRP" style="">
                    <div class="CON_LABEL" style="width:100px;">USEYN</div>
                    <div class="CON_OBJECT" style="width:400px;"><select id="F4_USEYN">
    ...
    <div class="GRP_LINE" >
        <div class="GRP_OBJECT" style="width:60%;">
            ...
            <div style="position: relative;width:100%;padding:0 0 0 0;">
                <div id="grid2" width="100%" height="150px" style="background-color:white;overflow:hidden"></div>
            </div>
        </div>
        <div class="GRP_OBJECT" style="width:40%;height:172px;">
