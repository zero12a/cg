//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "pjtcopyController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "pjtcopyController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "pjtcopyController.php?CTLGRP=G1&CTLFNC=RESET";// 변수 선언	
var obj_G1_FROM_PJTSEQ_valid = jQuery.parseJSON( '{ "G1_FROM_PJTSEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":20,  "DATATYPE":"NUMBER"} }' );  //FROM_PJTSEQ  밸리데이션
var obj_G1_TO_PJTSEQ_valid = jQuery.parseJSON( '{ "G1_TO_PJTSEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":20,  "DATATYPE":"NUMBER"} }' );  //TO_PJTSEQ  밸리데이션
var obj_G1_FROM_PJTSEQ; // FROM_PJTSEQ 변수선언var obj_G1_TO_PJTSEQ; // TO_PJTSEQ 변수선언//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "pjtcopyController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "pjtcopyController.php?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_RELOAD = "pjtcopyController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "pjtcopyController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "pjtcopyController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "pjtcopyController.php?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_RELOAD = "pjtcopyController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "pjtcopyController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_SEARCH = "pjtcopyController.php?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "pjtcopyController.php?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_ROWDELETE = "pjtcopyController.php?CTLGRP=G4&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G4_RELOAD = "pjtcopyController.php?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "pjtcopyController.php?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_CHKSAVE = "pjtcopyController.php?CTLGRP=G4&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG4,isToggleHiddenColG4,lastinputG4,lastinputG4json,lastrowidG4;
var lastselectG4json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G5_SEARCH = "pjtcopyController.php?CTLGRP=G5&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G5_SAVE = "pjtcopyController.php?CTLGRP=G5&CTLFNC=SAVE";
//컨트롤러 경로
var url_G5_ROWDELETE = "pjtcopyController.php?CTLGRP=G5&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G5_RELOAD = "pjtcopyController.php?CTLGRP=G5&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G5_HIDDENCOL = "pjtcopyController.php?CTLGRP=G5&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G5_CHKSAVE = "pjtcopyController.php?CTLGRP=G5&CTLFNC=CHKSAVE";
//그리드 객체
...
function G1_SEARCHALL(token){
	...
	lastinputG2 = new FormData(); //from CFG
	lastinputG3 = new FormData(); //from FILE
	lastinputG4 = new FormData(); //to CFG
	lastinputG5 = new FormData(); //to FILE
	//json : G1
    ...
    function G2_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[from CFG] Ajax http 500 error ( " + error + " )");
            }
        });
    ...
    function G3_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[from FILE] Ajax http 500 error ( " + error + " )");
            }
        });
    ...
    function G4_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[to CFG] Ajax http 500 error ( " + error + " )");
            }
        });
    ...
    function G5_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[to FILE] Ajax http 500 error ( " + error + " )");
            }
        });
...
function G5_CHKSAVE(){
	...
	//var ConAllData = $( "#condition" ).serialize();
//전송할 POST값 합치기
var postData = lastinputG5+ "&G5-CHK=" + arrRows ;
