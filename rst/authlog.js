//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "authlogController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "authlogController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "authlogController.php?CTLGRP=G1&CTLFNC=RESET";//컨 변수 선언	
//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "authlogController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_ROWDELETE = "authlogController.php?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWBULKADD = "authlogController.php?CTLGRP=G2&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G2_RELOAD = "authlogController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "authlogController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "authlogController.php?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "authlogController.php?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "authlogController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_ROWDELETE = "authlogController.php?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWBULKADD = "authlogController.php?CTLGRP=G3&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G3_RELOAD = "authlogController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "authlogController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "authlogController.php?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_CHKSAVE = "authlogController.php?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//디테일 변수 초기화	

var obj_G4_LAUTHD_SEQ_valid = jQuery.parseJSON( '{ "G4_LAUTHD_SEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // DSEQ 밸리데이션 선언
var obj_G4_PREPARE_SQL_valid = jQuery.parseJSON( '{ "G4_PREPARE_SQL": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // PREPARE 밸리데이션 선언
var obj_G4_FULL_SQL_valid = jQuery.parseJSON( '{ "G4_FULL_SQL": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // FULL 밸리데이션 선언
var obj_G4_ADD_DT_valid = jQuery.parseJSON( '{ "G4_ADD_DT": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":14,  "DATATYPE":"STRING"} }' );   // ADD 밸리데이션 선언
//폼뷰 컨트롤러 경로
var url_G4_SEARCH = "authlogController.php?CTLGRP=G4&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_G4_RELOAD = "authlogController.php?CTLGRP=G4&CTLFNC=RELOAD";
  ...
  alog("G2_INIT()-------------------------start");
	...
	//onCheck
		...
		//A124
			...
			', "RES_TOKEN" : "' + q(mygridG2.cells(rowID,mygridG2.getColIndexById("RES_TOKEN")).getValue()) + '"' +
			'}');
			G3_SEARCH(lastinputG3); //자식그룹 호출 : AUTHD
		});
  ...
  alog("G3_INIT()-------------------------start");
	...
	//onCheck
		...
		//A124
			...
			', "LAUTH_SEQ" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("LAUTH_SEQ")).getValue()) + '"' +
			'}');
			G4_SEARCH(lastinputG4); //자식그룹 호출 : AUTHD상세
		});
...
//컬럼 초기화
	//LAUTHD_SEQ, DSEQ 초기화		//ADD_DT, ADD 초기화	  alog("G4_INIT()-------------------------end");
}
	//D146 그룹별 기능 함수 출력	
//컨, 저장	
function G1_SAVE(){
    ...
    function G2_SEARCH(tinput){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[AUTH] Ajax http 500 error ( " + error + " )");
            }
        });
...
//그리드 행추가 : AUTHD
	function G3_ROWBULKADD(){
		if( !(lastinputG3json)|| !(lastinputG3json.RES_TOKEN) ){
			...
			var tCols = ["","",lastinputG3json.RES_TOKEN,"","","","","","",""];//초기값
    ...
    function G3_SEARCH(tinput){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[AUTHD] Ajax http 500 error ( " + error + " )");
            }
        });
