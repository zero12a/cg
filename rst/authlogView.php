...
<script src="authlog.js?<?=getRndVal(10)?>"></script></head>
...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--D72 : STARTTXT, TAG-->
	...
	<div class="GRP_OBJECT" style="width:50%;height:600px;">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG2"  style="background-color:white;overflow:hidden;height:578px;width:100%;"></div>
		</div>
	</div>
	<!--
	#####################################################
	...
	<div class="GRP_OBJECT" style="width:50%;height:400px;">
		<div sty_le="width:0px;height:0px;overflow: hidden">
			<form id="formviewG4" name="formviewG4" method="post" enctype="multipart/form-data">
		...
		<div class="DETAIL_LABELGRP">
			...
			<div class="DETAIL_LABELBTN"  style="">
				<input type="button" name="BTN_G4_RELOAD" value="새로고침" onclick="G4_RELOAD();">			</div>
		</div>
		...
		<!--I.COLID : LAUTHD_SEQ-->
			<div class="CON_OBJGRP" style="">
				<div class="CON_LABEL" style="width:60px;">	
					DSEQ	
				</div>	
				<!-- style="width:60;"-->
			...
			<DIV class="CON_LINE" is_br_tag>
		<!--PREPARE_SQL, PREPARE-->
			<div class="CON_OBJGRP" style="">			<div class="CON_LABEL" style="width:60px;">
				PREPARE
			</div>
