//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_C2_SEARCHALL = "appapiController.php?CTLGRP=C2&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_C2_SAVE = "appapiController.php?CTLGRP=C2&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_C2_RESET = "appapiController.php?CTLGRP=C2&CTLFNC=RESET";//컨디션1 변수 선언	
...
//컨트롤러 경로
var url_G3_SEARCH = "appapiController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_CHKSAVE = "appapiController.php?CTLGRP=G3&CTLFNC=CHKSAVE";
//컨트롤러 경로
var url_G3_SAVE = "appapiController.php?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_RELOAD = "appapiController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_EXCEL = "appapiController.php?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_HIDDENCOL = "appapiController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_ROWDELETE = "appapiController.php?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWADD = "appapiController.php?CTLGRP=G3&CTLFNC=ROWADD";
//그리드 객체
...
//폼뷰 컨트롤러 경로
var url_F4_SEARCH = "appapiController.php?CTLGRP=F4&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_F4_SAVE = "appapiController.php?CTLGRP=F4&CTLFNC=SAVE";
//폼뷰 컨트롤러 경로
var url_F4_RELOAD = "appapiController.php?CTLGRP=F4&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_F4_NEW = "appapiController.php?CTLGRP=F4&CTLFNC=NEW";
//폼뷰 컨트롤러 경로
var url_F4_DELETE = "appapiController.php?CTLGRP=F4&CTLFNC=DELETE";
//폼뷰 컨트롤러 경로
var url_F4_MOD = "appapiController.php?CTLGRP=F4&CTLFNC=MOD";
