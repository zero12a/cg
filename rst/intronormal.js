...
//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "intronormalController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_RELOAD = "intronormalController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "intronormalController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "intronormalController.php?CTLGRP=G2&CTLFNC=EXCEL";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "intronormalController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_RELOAD = "intronormalController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "intronormalController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "intronormalController.php?CTLGRP=G3&CTLFNC=EXCEL";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_SEARCH = "intronormalController.php?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_RELOAD = "intronormalController.php?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "intronormalController.php?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "intronormalController.php?CTLGRP=G4&CTLFNC=EXCEL";
//그리드 객체
  ...
  alog("G3_INIT()-------------------------start");
	...
	//onCheck
		...
		mygridG3.attachEvent("onRowSelect",function(rowID,celInd){
			...
			//', "LOGIN_SEQ" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("LOGIN_SEQ")).getValue()) + '"' +
			//', "USR_ID" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("USR_ID")).getValue()) + '"' +
			//', "SESSION_ID" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("SESSION_ID")).getValue()) + '"' +
			//', "SUCCESS_YN" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("SUCCESS_YN")).getValue()) + '"' +
			//', "LOCKCD" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("LOCKCD")).getValue()) + '"' +
			//', "PW_ERR_CNT" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("PW_ERR_CNT")).getValue()) + '"' +
			//', "LOCK_LIMIT_DT" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("LOCK_LIMIT_DT")).getValue()) + '"' +
  ...
  alog("G4_INIT()-------------------------start");
	...
	//onCheck
		...
		mygridG4.attachEvent("onRowSelect",function(rowID,celInd){
			...
			//', "LAUTH_SEQ" : "' + q(mygridG4.cells(rowID,mygridG4.getColIndexById("LAUTH_SEQ")).getValue()) + '"' +
			//', "REQ_TOKEN" : "' + q(mygridG4.cells(rowID,mygridG4.getColIndexById("REQ_TOKEN")).getValue()) + '"' +
			//', "RES_TOKEN" : "' + q(mygridG4.cells(rowID,mygridG4.getColIndexById("RES_TOKEN")).getValue()) + '"' +
			...
			//', "SUCCESS_YN" : "' + q(mygridG4.cells(rowID,mygridG4.getColIndexById("SUCCESS_YN")).getValue()) + '"' +
    ...
    function G2_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[로그인] Ajax http 500 error ( " + error + " )");
            }
        });
    ...
    function G3_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[잠금] Ajax http 500 error ( " + error + " )");
            }
        });
    ...
    function G4_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[메뉴이력] Ajax http 500 error ( " + error + " )");
            }
        });
