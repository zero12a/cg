//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "usrmngController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "usrmngController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "usrmngController.php?CTLGRP=G1&CTLFNC=RESET";//조회조건 변수 선언	
...
//컨트롤러 경로
var url_G2_SEARCH = "usrmngController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "usrmngController.php?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_ROWDELETE = "usrmngController.php?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWADD = "usrmngController.php?CTLGRP=G2&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G2_RELOAD = "usrmngController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "usrmngController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "usrmngController.php?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "usrmngController.php?CTLGRP=G2&CTLFNC=CHKSAVE";
//컨트롤러 경로
var url_G2_SAVEPWD = "usrmngController.php?CTLGRP=G2&CTLFNC=SAVEPWD";
//그리드 객체
...
//폼뷰 컨트롤러 경로
var url_G3_SEARCH = "usrmngController.php?CTLGRP=G3&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_G3_SAVE = "usrmngController.php?CTLGRP=G3&CTLFNC=SAVE";
//폼뷰 컨트롤러 경로
var url_G3_RELOAD = "usrmngController.php?CTLGRP=G3&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_G3_NEW = "usrmngController.php?CTLGRP=G3&CTLFNC=NEW";
//폼뷰 컨트롤러 경로
var url_G3_MODIFY = "usrmngController.php?CTLGRP=G3&CTLFNC=MODIFY";
//폼뷰 컨트롤러 경로
var url_G3_DELETE = "usrmngController.php?CTLGRP=G3&CTLFNC=DELETE";
...
function G2_INIT(){
  alog("G2_INIT()-------------------------start");
	...
	//요청 토큰
	var token = uuidv4();
		G3_SEARCH(lastinputG3,token); //자식그룹 호출 : 회원상세
		});
    ...
    function G2_SEARCH(tinput,token){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[회원목록] Ajax http 500 error ( " + error + " )");
            }
        });
...
function G2_RELOAD(token){
  ...
  G2_SEARCH(lastinputG2,token);
	...
	$.ajax({
		type : "POST",
		url : url_G2_SAVEPWD + "&TOKEN=" + token + "&" + lastinputG2 ,
		data : { "G2-XML" : myXmlString},
		dataType: "json",
		async: false,
		success: function(data){
