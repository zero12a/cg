//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "layoutmngController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "layoutmngController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "layoutmngController.php?CTLGRP=G1&CTLFNC=RESET";// 변수 선언	
var obj_G1_LAYOUTID_valid = jQuery.parseJSON( '{ "G1_LAYOUTID": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );  //LAYOUTID  밸리데이션
var obj_G1_LAYOUTID; // LAYOUTID 변수선언//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "layoutmngController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "layoutmngController.php?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_ROWDELETE = "layoutmngController.php?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWBULKADD = "layoutmngController.php?CTLGRP=G2&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G2_ROWADD = "layoutmngController.php?CTLGRP=G2&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G2_RELOAD = "layoutmngController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "layoutmngController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "layoutmngController.php?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "layoutmngController.php?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "layoutmngController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "layoutmngController.php?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_ROWDELETE = "layoutmngController.php?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWBULKADD = "layoutmngController.php?CTLGRP=G3&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G3_ROWADD = "layoutmngController.php?CTLGRP=G3&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G3_RELOAD = "layoutmngController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "layoutmngController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "layoutmngController.php?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_CHKSAVE = "layoutmngController.php?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
  ...
  alog("G2_INIT()-------------------------start");
	...
	//onCheck
		...
		//A124
			...
			', "PJTSEQ" : "' + q(mygridG2.cells(rowID,mygridG2.getColIndexById("PJTSEQ")).getValue()) + '"' +
			'}');
		G3_SEARCH(lastinputG3); //자식그룹 호출 : LAYOUTD
		});
    ...
    function G2_SEARCH(tinput){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[LAYOUT] Ajax http 500 error ( " + error + " )");
            }
        });
...
//그리드 행추가 : LAYOUTD
	function G3_ROWADD(){
		if( !(lastinputG3json)|| !(lastinputG3json.LAYOUTID) || !(lastinputG3json.PJTSEQ) ){
			...
			var tCols = ["",lastinputG3json.PJTSEQ,lastinputG3json.LAYOUTID,"","","","","","","","",""];//초기값
    ...
    function G3_SEARCH(tinput){
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[LAYOUTD] Ajax http 500 error ( " + error + " )");
            }
        });
