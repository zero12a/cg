...
$REQ["G2-FOLDER_SEQ"] = getFilter($REQ["G2-FOLDER_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G2-FOLDER_ORD"] = getFilter($REQ["G2-FOLDER_ORD"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-MNU_SEQ"] = getFilter($REQ["G3-MNU_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-MNU_ORD"] = getFilter($REQ["G3-MNU_ORD"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G3-FOLDER_SEQ"] = reqPostNumber("G3-FOLDER_SEQ",30);//FOLDER_SEQ	
$REQ["G3-FOLDER_SEQ"] = getFilter($REQ["G3-FOLDER_SEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G2-XML"] = getXml2Array($_POST["G2-XML"]);//폴더	
	...
	array(
		...
		,"FILTER"=>
			array(
			"FOLDER_SEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"FOLDER_NM"=>array("SAFETEXT","/--미 정의--/")
			,"USE_YN"=>array("SAFETEXT","/--미 정의--/")
			,"FOLDER_ORD"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
...
$REQ["G3-CHK"] = filterGridChk($REQ["G3-CHK"],"STRING",20,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//MNU_SEQ 입력값검증
