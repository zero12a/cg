...
alog("DdiomngControl___________________________start");
...
$REQ["G2-PGMSEQ"] = getFilter($REQ["G2-PGMSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-IOSEQ"] = reqPostNumber("G2-IOSEQ",30);//IOSEQ	
$REQ["G2-IOSEQ"] = getFilter($REQ["G2-IOSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-DD_DATASIZE"] = reqPostString("G2-DD_DATASIZE",30);//DD SIZE	
$REQ["G2-DD_DATASIZE"] = getFilter($REQ["G2-DD_DATASIZE"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-IO_DATASIZE"] = reqPostString("G2-IO_DATASIZE",30);//IO SIZE	
$REQ["G2-IO_DATASIZE"] = getFilter($REQ["G2-IO_DATASIZE"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-ADDDT"] = reqPostString("G2-ADDDT",14);//ADDDT	
$REQ["G2-ADDDT"] = getFilter($REQ["G2-ADDDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-MODDT"] = reqPostString("G2-MODDT",14);//MODDT	
$REQ["G2-MODDT"] = getFilter($REQ["G2-MODDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-PGMSEQ"] = getFilter($REQ["G3-PGMSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G3-IOSEQ"] = reqPostNumber("G3-IOSEQ",30);//IOSEQ	
$REQ["G3-IOSEQ"] = getFilter($REQ["G3-IOSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G3-ADDDT"] = getFilter($REQ["G3-ADDDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G3-MODDT"] = reqPostString("G3-MODDT",14);//MODDT	
$REQ["G3-MODDT"] = getFilter($REQ["G3-MODDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
...
$REQ["G4-PGMSEQ"] = getFilter($REQ["G4-PGMSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G4-IOSEQ"] = reqPostNumber("G4-IOSEQ",30);//IOSEQ	
$REQ["G4-IOSEQ"] = getFilter($REQ["G4-IOSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G4-DD_VALIDSEQ"] = reqPostNumber("G4-DD_VALIDSEQ",30);//DD VALID	
$REQ["G4-DD_VALIDSEQ"] = getFilter($REQ["G4-DD_VALIDSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G4-IO_VALIDSEQ"] = reqPostNumber("G4-IO_VALIDSEQ",30);//IO VALID	
$REQ["G4-IO_VALIDSEQ"] = getFilter($REQ["G4-IO_VALIDSEQ"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G4-ADDDT"] = reqPostString("G4-ADDDT",14);//ADDDT	
$REQ["G4-ADDDT"] = getFilter($REQ["G4-ADDDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G4-MODDT"] = reqPostString("G4-MODDT",14);//MODDT	
$REQ["G4-MODDT"] = getFilter($REQ["G4-MODDT"],"REGEXMAT","/^[0-9]{1}[0-9]*$/");	
$REQ["G2-XML"] = getXml2Array($_POST["G2-XML"]);//DATASIZE	
	...
	array(
		...
		,"FILTER"=>
			...
			,"PGMSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"IOSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"DD_DATASIZE"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"IO_DATASIZE"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"ADDDT"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"MODDT"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
					)
	)
);
...
$REQ["G4-XML"] = filterGridXml(
	array(
		...
		,"FILTER"=>
			...
			,"PGMSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"IOSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"DD_VALIDSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"IO_VALIDSEQ"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"ADDDT"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
			,"MODDT"=>array("REGEXMAT","/^[0-9]{1}[0-9]*$/")
					)
	)
...
$REQ["G2-CHK"] = filterGridChk($REQ["G2-CHK"],"NUMBER",30,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//IOSEQ 입력값검증
	$REQ["G3-CHK"] = $_POST["G3-CHK"];//CHK 받기
//filterGridChk($tStr,$tDataType,$tDataSize,$tValidType,$tValidRule)
$REQ["G3-CHK"] = filterGridChk($REQ["G3-CHK"],"NUMBER",30,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//IOSEQ 입력값검증
	$REQ["G4-CHK"] = $_POST["G4-CHK"];//CHK 받기
//filterGridChk($tStr,$tDataType,$tDataSize,$tValidType,$tValidRule)
$REQ["G4-CHK"] = filterGridChk($REQ["G4-CHK"],"NUMBER",30,"REGEXMAT","/^[0-9]{1}[0-9]*$/");//IOSEQ 입력값검증
...
alog("DdiomngControl___________________________end");
