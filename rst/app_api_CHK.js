...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
		...
		//헤더초기화
        mygridG3.setHeader("SEQ,NM,ID,URL,REQENCTYPE,REQDATATYPE,REQBODY,RESBODY,MYFILE,MYFILESVRNM,ADD,MOD");
		mygridG3.setColumnIds("API_SEQ,API_NM,PGM_ID,URL,REQ_ENCTYPE,REQ_DATATYPE,REQ_BODY,RES_BODY,MYFILE,MYFILESVRNM,ADD_DT,MOD_DT");
		mygridG3.setColTypes("ed,ed,ed,ed,co,co,txttxt,txttxt,ed,ed,ro,ro");
...
function C2_GOGO(){
	var arrRows =  mygridG3.getCheckedRows(0); //0번째 컬럼
