//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "deploymngController.php?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "deploymngController.php?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "deploymngController.php?CTLGRP=G1&CTLFNC=RESET";// 변수 선언	
...
//컨트롤러 경로
var url_G2_SEARCH = "deploymngController.php?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "deploymngController.php?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_RELOAD = "deploymngController.php?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "deploymngController.php?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "deploymngController.php?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "deploymngController.php?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "deploymngController.php?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "deploymngController.php?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_RELOAD = "deploymngController.php?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "deploymngController.php?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "deploymngController.php?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_CHKSAVE = "deploymngController.php?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_SEARCH = "deploymngController.php?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "deploymngController.php?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_RELOAD = "deploymngController.php?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "deploymngController.php?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "deploymngController.php?CTLGRP=G4&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G4_CHKSAVE = "deploymngController.php?CTLGRP=G4&CTLFNC=CHKSAVE";
//그리드 객체
...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
	...
	//가로 정렬
		...
		mygridG3.setColSorting("int,int,str,str,str,str,str,str,str,str");		//렌더링
...
function G1_SEARCHALL(token){
	...
	//  호출
	G2_SEARCH(lastinputG2json,token);
	//  호출
	G3_SEARCH(lastinputG3json,token);
	//  호출
	G4_SEARCH(lastinputG4json,token);
...
var postData = lastinputG2+ "&G2-CHK=" + arrRows ;
	...
	var myXmlString = tgrid.serialize();
		...
		var keys = $.map( lastinputG2json, function( value, key ) {
			alog("key=" + key + ", value=" + value);
...
function G2_EXCEL(){	
    ...
    function G2_SEARCH(tinput,token){
        ...
        //post 만들기
		sendFormData = new FormData($("#condition")[0]);
		var keys = $.map( tinput, function( value, key ) {
			alog("key=" + key + ", value=" + value);
			sendFormData.append(key, value);
			return key;
		});
...
var postData = lastinputG3+ "&G3-CHK=" + arrRows ;
	...
	var myXmlString = tgrid.serialize();
        //post 만들기
		sendFormData = new FormData($("#condition")[0]);
		var keys = $.map( lastinputG3json, function( value, key ) {
			alog("key=" + key + ", value=" + value);
			sendFormData.append(key, value);
			return key;
		});
...
var postData = lastinputG4+ "&G4-CHK=" + arrRows ;
	...
	var myXmlString = tgrid.serialize();
        //post 만들기
		sendFormData = new FormData($("#condition")[0]);
		var keys = $.map( lastinputG4json, function( value, key ) {
			alog("key=" + key + ", value=" + value);
			sendFormData.append(key, value);
			return key;
		});
