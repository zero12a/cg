...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
	...
	//onCheck
		...
		lastinputG4.append("G3-TEAM_NM", mygridG3.cells(rowID,mygridG3.getColIndexById("TEAM_NM")).getValue()); // 
...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
	...
	//onCheck
		...
		lastinputG5.append("G4-SUBSYS_NM", mygridG4.cells(rowID,mygridG4.getColIndexById("SUBSYS_NM")).getValue()); // 
		lastinputG5.append("G4-SYS_NM", mygridG4.cells(rowID,mygridG4.getColIndexById("SYS_NM")).getValue()); // 
		lastinputG5.append("G4-TEAM_NM", mygridG4.cells(rowID,mygridG4.getColIndexById("TEAM_NM")).getValue()); // 
