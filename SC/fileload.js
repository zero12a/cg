...
function G2_INIT(){
  alog("G2_INIT()-------------------------start");
		...
		//헤더초기화
        mygridG2.setHeader("#master_checkbox,CAL,SEQ,FILE_NM,TEAM_NM,TEAM_NM_LEN,SYS_NM,SYS_NM_LEN,SUBSYS_NM,SUBSYS_NM_LEN,FILE_HASH,XML_VERSION,XML_TIMESTAMP,XML_ANAL_TIMESTAMP,XML_DT,XML_ANAL_DT,BUG_CNT,LOAD_END_DT,ADD_DT,MOD_DT");
		mygridG2.setColumnIds("CHK,CAL,LOAD_SEQ,FILE_NM,TEAM_NM,TEAM_NM_LEN,SYS_NM,SYS_NM_LEN,SUBSYS_NM,SUBSYS_NM_LEN,FILE_HASH,XML_VERSION,XML_TIMESTAMP,XML_ANAL_TIMESTAMP,XML_DT,XML_ANAL_DT,BUG_CNT,LOAD_END_DT,ADD_DT,MOD_DT");
		mygridG2.setInitWidths("60,70,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60");
		mygridG2.setColTypes("ch,dhxCalendarA,ro,ro,ed,ro,ed,ro,ed,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	//가로 정렬	
		mygridG2.setColAlign("left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
		mygridG2.setColSorting("str,str,int,str,str,int,str,int,str,int,str,str,str,str,str,str,int,str,str,str");		//렌더링	
		mygridG2.enableSmartRendering(false);
		mygridG2.enableMultiselect(true);
		//mygridG2.setColValidators("G2_CHK,G2_CAL,G2_LOAD_SEQ,G2_FILE_NM,G2_TEAM_NM,G2_TEAM_NM_LEN,G2_SYS_NM,G2_SYS_NM_LEN,G2_SUBSYS_NM,G2_SUBSYS_NM_LEN,G2_FILE_HASH,G2_XML_VERSION,G2_XML_TIMESTAMP,G2_XML_ANAL_TIMESTAMP,G2_XML_DT,G2_XML_ANAL_DT,G2_BUG_CNT,G2_LOAD_END_DT,G2_ADD_DT,G2_MOD_DT");
	...
	//onCheck
		...
		mygridG2.attachEvent("onRowSelect",function(rowID,celInd){
			...
			//', "CAL" : "' + q(mygridG2.cells(rowID,mygridG2.getColIndexById("CAL")).getValue()) + '"' +
		...
		//A124
			...
			'}');
		lastinputG3 = new HashMap(); // 4
		lastinputG3.set("G2-LOAD_SEQ", mygridG2.cells(rowID,mygridG2.getColIndexById("LOAD_SEQ")).getValue().replace(/&amp;/g, "&")); // 
...
function G2_EXCEL(){	
	...
	$("#DATA_HEADERS").val("CHK,CAL,LOAD_SEQ,FILE_NM,TEAM_NM,TEAM_NM_LEN,SYS_NM,SYS_NM_LEN,SUBSYS_NM,SUBSYS_NM_LEN,FILE_HASH,XML_VERSION,XML_TIMESTAMP,XML_ANAL_TIMESTAMP,XML_DT,XML_ANAL_DT,BUG_CNT,LOAD_END_DT,ADD_DT,MOD_DT");
	$("#DATA_WIDTHS").val("60,70,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60");
