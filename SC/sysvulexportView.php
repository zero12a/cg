...
<script src="sysvulexport.js?<?=getRndVal(10)?>"></script>
...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--D72 : STARTTXT, TAG-->
	...
	<!--TEAM_NM오브젝트출력-->						<input type="text" name="G1-TEAM_NM" value="<?=getFilter(reqPostString("TEAM_NM",100),"SAFEECHO","")?>" id="G1-TEAM_NM" style="width:100px;">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	#####################################################
	-->
	<div class="GRP_OBJECT" style="width:100%;height:600px;">
