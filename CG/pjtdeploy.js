//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "pjtdeployController?CTLGRP=G1&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "pjtdeployController?CTLGRP=G1&CTLFNC=RESET";
// 변수 선언	
var obj_G1_PJTNM; // 프로젝트명 변수선언
//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "pjtdeployController?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "pjtdeployController?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_RELOAD = "pjtdeployController?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_EXCEL = "pjtdeployController?CTLGRP=G2&CTLFNC=EXCEL";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//디테일 변수 초기화	

//폼뷰 컨트롤러 경로
var url_G3_RELOAD = "pjtdeployController?CTLGRP=G3&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_G3_EXCEL = "pjtdeployController?CTLGRP=G3&CTLFNC=EXCEL";
//폼뷰 컨트롤러 경로
var url_G3_SEARCH = "pjtdeployController?CTLGRP=G3&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_G3_SAVE = "pjtdeployController?CTLGRP=G3&CTLFNC=SAVE";
