...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--
	...
	<!--FROM_PJTSEQ오브젝트출력-->						<input type="text" name="G1-FROM_PJTSEQ" value="<?=getFilter(reqPostString("FROM_PJTSEQ",20),"SAFEECHO","")?>" id="G1-FROM_PJTSEQ" style="width:100px;">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : TO_PJTSEQ-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--TO_PJTSEQ오브젝트출력-->						<input type="text" name="G1-TO_PJTSEQ" value="<?=getFilter(reqPostString("TO_PJTSEQ",20),"SAFEECHO","")?>" id="G1-TO_PJTSEQ" style="width:100px;">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
...
<input type="button" name="BTN_G2_SAVE" value="Copy" onclick="G2_SAVE(uuidv4());">
...
<input type="button" name="BTN_G2_HIDDENCOL" value="숨김필드보기" onclick="G2_HIDDENCOL(uuidv4());">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG2"  style="background-color:white;overflow:hidden;height:265px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
...
<input type="button" name="BTN_G3_SAVE" value="Copy" onclick="G3_SAVE(uuidv4());">
...
<input type="button" name="BTN_G3_HIDDENCOL" value="숨김필드보기" onclick="G3_HIDDENCOL(uuidv4());">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG3"  style="background-color:white;overflow:hidden;height:265px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
...
<input type="button" name="BTN_G4_CHKSAVE" value="선택저장" onclick="G4_CHKSAVE(uuidv4());">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG4"  style="background-color:white;overflow:hidden;height:265px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
...
<input type="button" name="BTN_G5_HIDDENCOL" value="숨김필드보기" onclick="G5_HIDDENCOL(uuidv4());">
<input type="button" name="BTN_G5_CHKSAVE" value="선택저장" onclick="G5_CHKSAVE(uuidv4());">
			</div>
			</div><!--GAP-->
		</div>
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG5"  style="background-color:white;overflow:hidden;height:265px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
