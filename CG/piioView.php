	...
	<!--COLNM오브젝트출력-->						<input type="text" name="G3-COLNM" value="" id="G3-COLNM" style="width:100px;">
			...
			<!--I.COLID : DATATYPE-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--DATATYPE오브젝트출력-->						<input type="text" name="G3-DATATYPE" value="" id="G3-DATATYPE" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : VALIDSEQ-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--VALIDSEQ오브젝트출력-->						<input type="text" name="G3-VALIDSEQ" value="" id="G3-VALIDSEQ" style="width:100px;">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : DATASIZE-->
	...
	<!--OBJALIGN오브젝트출력-->						<input type="text" name="G3-OBJALIGN" value="" id="G3-OBJALIGN" style="width:100px;">
			...
			<!--I.COLID : HIDDENYN-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--HIDDENYN오브젝트출력-->						<input type="text" name="G3-HIDDENYN" value="" id="G3-HIDDENYN" style="width:100px;">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : EDITYN-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--EDITYN오브젝트출력-->						<input type="text" name="G3-EDITYN" value="" id="G3-EDITYN" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : FNINIT-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--FNINIT오브젝트출력-->						<input type="text" name="G3-FNINIT" value="" id="G3-FNINIT" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
