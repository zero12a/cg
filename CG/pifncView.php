...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--
	...
	<!--FNCID오브젝트출력-->						<input type="text" name="G1-FNCID" value="<?=getFilter(reqPostString("FNCID",30),"SAFEECHO","")?>" id="G1-FNCID" style="width:70px;">
					</div>
				</div>
					<!-- GRPSEQ -->
			...
			<!--I.COLID : FNCNM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:70px;"-->
					<div class="CON_OBJECT">
	<!--FNCNM오브젝트출력-->						<input type="text" name="G1-FNCNM" value="<?=getFilter(reqPostString("FNCNM",30),"SAFEECHO","")?>" id="G1-FNCNM" style="width:70px;">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
