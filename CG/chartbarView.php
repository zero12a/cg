...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--
	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<div style="height:62px;border-radius:3px;-moz-border-radius: 3px;" class="CONDITION_OBJECT">
    ...
    <div class="GRP_OBJECT" style="width:50%;">
		...
		<div class="CHART_LABELGRP">
			...
			<div class="CHART_OBJECT" style="border-radius:3px;-moz-border-radius: 3px;">
				<canvas id="canvasG2" style="width:100%;height:462px"></canvas>
		</div>
			</div></div>
	</div>
	<!--
    ...
    <div class="GRP_OBJECT" style="width:50%;">
		...
		<div class="CHART_LABELGRP">
			...
			<div class="CHART_OBJECT" style="border-radius:3px;-moz-border-radius: 3px;">
			<canvas id="canvasG3" style="width:100%;height:462px"></canvas>
		</div>
			</div>
		</div>
	</div>
