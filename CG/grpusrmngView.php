...
<input type="button" name="BTN_G2_HIDDENCOL" value="V" onclick="G2_HIDDENCOL(uuidv4());">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG2"  style="background-color:white;overflow:hidden;height:165px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
...
<input type="button" name="BTN_G3_CHKSAVE" value="선택 삭제" onclick="G3_CHKSAVE(uuidv4());">
			</div>
			</div><!--GAP-->
		</div>
		<div  class="GRID_OBJECT"  style="">
...
<input type="button" name="BTN_G4_CHKSAVE" value="선택 추가" onclick="G4_CHKSAVE(uuidv4());">
			</div>
			</div><!--GAP-->
		</div>
		<div  class="GRID_OBJECT"  style="">
