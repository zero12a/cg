...
var obj_G3_INHERITSEQ_valid = jQuery.parseJSON( '{ "G3_INHERITSEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"NUMBER"} }' );   // INHERITSEQ 밸리데이션 선언
...
var obj_G3_CHILDGRPID_valid = jQuery.parseJSON( '{ "G3_CHILDGRPID": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":40,  "DATATYPE":"STRING"} }' );   // CHILDGRPID 밸리데이션 선언
...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
	...
	//컬럼 초기화
	//INHERITSEQ, INHERITSEQ 초기화		//PJTSEQ, PJTSEQ 초기화		//PGMSEQ, PGMSEQ 초기화		//GRPSEQ, GRPSEQ 초기화		//COLID, 컬럼ID 초기화	
	//CHILDGRPID, CHILDGRPID 초기화	
...
function G3_NEW(){
	...
	$("#G3-CTLCUD").val("C");
	//PMGIO 로직
	$("#G3-INHERITSEQ").text("");//INHERITSEQ 신규초기화		$("#G3-PJTSEQ").text("");//PJTSEQ 신규초기화		$("#G3-PGMSEQ").text("");//PGMSEQ 신규초기화		$("#G3-GRPSEQ").text("");//GRPSEQ 신규초기화		$("#G3-COLID").val("");//컬럼ID 신규초기화	
...
function G3_SEARCH(tinput,token){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $("#G3-CTLCUD").val("R");
			//SETVAL  가져와서 세팅
			$("#G3-INHERITSEQ").text(data.RTN_DATA.INHERITSEQ);//INHERITSEQ 변수세팅
