...
include_once('piinheritService.php');
...
alog("PiinheritControl___________________________start");
...
//G2, 
$REQ["G2-INHERITSEQ"] = reqPostNumber("G2-INHERITSEQ",30);//INHERITSEQ	
...
$REQ["G2-CHILDGRPID"] = reqPostString("G2-CHILDGRPID",40);//CHILDGRPID	
$REQ["G2-CHILDGRPID"] = getFilter($REQ["G2-CHILDGRPID"],"REGEXMAT","/^[a-zA-Z]{1}[a-zA-Z0-9]*$/");	
...
alog("PiinheritControl___________________________end");
