...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
		...
		//헤더초기화
        mygridG4.setHeader("SERVERSEQ,SVRID,SVRNM,PJTSEQ,USERSEQ,DBHOST,DBPORT,DBNAME,DBUSERID,img:["+ CFG_URL_LIBS_ROOT + "img/crypt_shield.png]DBUSERPW,사용유무,ADDDT,수정일");
