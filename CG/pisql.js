...
var obj_G3_SQLID_valid = jQuery.parseJSON( '{ "G3_SQLID": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // SQLID 밸리데이션 선언
var obj_G3_SQLNM_valid = jQuery.parseJSON( '{ "G3_SQLNM": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // SQLNM 밸리데이션 선언
var obj_G3_SVRSEQ_valid = jQuery.parseJSON( '{ "G3_SVRSEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":20,  "DATATYPE":"NUMBER"} }' );   // SERVERSEQ 밸리데이션 선언
var obj_G3_CRUD_valid = jQuery.parseJSON( '{ "G3_CRUD": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":1,  "DATATYPE":"STRING"} }' );   // CRUD 밸리데이션 선언
var obj_G3_RTN_TYPE_valid = jQuery.parseJSON( '{ "G3_RTN_TYPE": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // RTN_TYPE 밸리데이션 선언
var obj_G3_SQLORD_valid = jQuery.parseJSON( '{ "G3_SQLORD": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":10,  "DATATYPE":"NUMBER"} }' );   // ORD 밸리데이션 선언
var obj_G3_PSQLSEQ_valid = jQuery.parseJSON( '{ "G3_PSQLSEQ": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"NUMBER"} }' );   // PSQLSEQ 밸리데이션 선언
var obj_G3_SQLTXT_valid = jQuery.parseJSON( '{ "G3_SQLTXT": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":1000,  "DATATYPE":"STRING"} }' );   // SQLTXT 밸리데이션 선언
...
function G3_SEARCH(tinput,token){
    ...
    $.ajax({
		...
		$("#G3-SQLTXT").val(data.RTN_DATA.SQLTXT);//SQLTXT 오브젝트 값세팅
