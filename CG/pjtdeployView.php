...
<script src="pjtdeploy.js?<?=getRndVal(10)?>"></script>
<script>
...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--PJTNM오브젝트출력-->						<input type="text" name="G1-PJTNM" value="<?=getFilter(reqPostString("PJTNM",100),"SAFEECHO","")?>" id="G1-PJTNM" style="width:60px;">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	<!--PJTSEQ오브젝트출력-->						<input type="text" name="G3-PJTSEQ" value="" id="G3-PJTSEQ" style="width:100px;">
			...
			<!--I.COLID : PJTID-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--PJTID오브젝트출력-->						<input type="text" name="G3-PJTID" value="" id="G3-PJTID" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : PJTNM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--PJTNM오브젝트출력-->						<input type="text" name="G3-PJTNM" value="" id="G3-PJTNM" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : FILECHARSET-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--FILECHARSET오브젝트출력-->						<input type="text" name="G3-FILECHARSET" value="" id="G3-FILECHARSET" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : UITOOL-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--UITOOL오브젝트출력-->						<input type="text" name="G3-UITOOL" value="" id="G3-UITOOL" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : SVRLANG-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--SVRLANG오브젝트출력-->						<input type="text" name="G3-SVRLANG" value="" id="G3-SVRLANG" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : DEPLOYKEY-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--DEPLOYKEY오브젝트출력-->						<input type="text" name="G3-DEPLOYKEY" value="" id="G3-DEPLOYKEY" style="width:100px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : PKGROOT-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--PKGROOT오브젝트출력-->						<input type="text" name="G3-PKGROOT" value="" id="G3-PKGROOT" style="width:100px;">
					</div>
				</div>
			</DIV>
			<DIV class="OBJ_BR"></DIV>
		...
		<div class="CON_OBJECT">
			<input type="text" name="G3-STARTDT" value="" id="G3-STARTDT" style="width:100px;">
		</div>
	</div>
		<!--D101: STARTTXT, TAG-->
		<!--I.COLID : ENDDT-->
		...
		<div class="CON_OBJECT">
			<input type="text" name="G3-ENDDT" value="" id="G3-ENDDT" style="width:100px;">
		</div>
	</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : DELYN-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:40px;"-->
					<div class="CON_OBJECT">
	<!--DELYN오브젝트출력-->						<input type="text" name="G3-DELYN" value="" id="G3-DELYN" style="width:40px;">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
