...
include_once('pisqlrService.php');
...
alog("PisqlrControl___________________________start");
...
//G2, 
$REQ["G2-SQLRSEQ"] = reqPostNumber("G2-SQLRSEQ",30);//SQLRSEQ	
...
alog("PisqlrControl___________________________end");
