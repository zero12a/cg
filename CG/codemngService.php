...
class codemngService 
{
	...
	public function goG4Search(){
		...
		alog("CODEMNGService-goG4Search________________________start");
//FORMVIEW SEARCH
	//암호화컬럼
...
// SQL LOOP
		...
		$rtnVal->ERR_CD = "200";
		echo json_encode($rtnVal);
		alog("CODEMNGService-goG4Search________________________end");
	}
	//상세폼, 저장
	public function goG4Save(){
		...
		alog("CODEMNGService-goG4Save________________________start");
		//FORMVIEW SAVE
		$grpId="G4";
	...
	//암호화컬럼
		...
		$rtnVal->ERR_CD = "200";
		echo json_encode($rtnVal);
		alog("CODEMNGService-goG4Save________________________end");
	}
	//상세폼, 삭제
	public function goG4Delete(){
		...
		alog("CODEMNGService-goG4Delete________________________start");
		//처리 결과 리턴
		$rtnVal->RTN_CD = "200";
		$rtnVal->ERR_CD = "200";
		echo json_encode($rtnVal);
		alog("CODEMNGService-goG4Delete________________________end");
	}
}
