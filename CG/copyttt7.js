//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "copyttt7Controller?CTLGRP=G1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "copyttt7Controller?CTLGRP=G1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "copyttt7Controller?CTLGRP=G1&CTLFNC=RESET";//1 변수 선언	
var obj_G1_MYRADIO; // 나의라디오 변수선언var obj_G1_ADD_DT; // ADD 변수선언var obj_G1_MYCHECK; // 체크 변수선언var obj_G1_PNM; // PNM 변수선언//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "copyttt7Controller?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "copyttt7Controller?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_ROWDELETE = "copyttt7Controller?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWADD = "copyttt7Controller?CTLGRP=G2&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G2_RELOAD = "copyttt7Controller?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "copyttt7Controller?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_CHKSAVE = "copyttt7Controller?CTLGRP=G2&CTLFNC=CHKSAVE";
//컨트롤러 경로
var url_G2_edit = "copyttt7Controller?CTLGRP=G2&CTLFNC=edit";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_ROWBULKADD = "copyttt7Controller?CTLGRP=G3&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G3_ROWADD = "copyttt7Controller?CTLGRP=G3&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G3_RELOAD = "copyttt7Controller?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "copyttt7Controller?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "copyttt7Controller?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_CHKSAVE = "copyttt7Controller?CTLGRP=G3&CTLFNC=CHKSAVE";
//컨트롤러 경로
var url_G3_SEARCH = "copyttt7Controller?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "copyttt7Controller?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_ROWDELETE = "copyttt7Controller?CTLGRP=G3&CTLFNC=ROWDELETE";
//그리드 객체
...
var obj_G4_HIDDENLINK_valid = jQuery.parseJSON( '{ "G4_HIDDENLINK": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":50,  "DATATYPE":"STRING"} }' );   // 히든링크 밸리데이션 선언
var obj_G4_PCD_valid = jQuery.parseJSON( '{ "G4_PCD": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":30,  "DATATYPE":"STRING"} }' );   // PCD 밸리데이션 선언
var obj_G4_IMG_valid = jQuery.parseJSON( '{ "G4_IMG": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":200,  "DATATYPE":"STRING"} }' );   // 이미지뷰어 밸리데이션 선언
var obj_G4_TFILE_valid = jQuery.parseJSON( '{ "G4_TFILE": {"REQUARED":"",  "MIN":"",  "MAX":"",  "DATASIZE":200,  "DATATYPE":"STRING"} }' );   // 파일 밸리데이션 선언
//폼뷰 컨트롤러 경로
var url_G4_USERDEF = "copyttt7Controller?CTLGRP=G4&CTLFNC=USERDEF";
//폼뷰 컨트롤러 경로
var url_G4_SEARCH = "copyttt7Controller?CTLGRP=G4&CTLFNC=SEARCH";
//폼뷰 컨트롤러 경로
var url_G4_RELOAD = "copyttt7Controller?CTLGRP=G4&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_G4_NEW = "copyttt7Controller?CTLGRP=G4&CTLFNC=NEW";
//폼뷰 컨트롤러 경로
var url_G4_MODIFY = "copyttt7Controller?CTLGRP=G4&CTLFNC=MODIFY";
//폼뷰 컨트롤러 경로
var url_G4_DELETE = "copyttt7Controller?CTLGRP=G4&CTLFNC=DELETE";
//폼뷰 컨트롤러 경로
var url_G4_save = "copyttt7Controller?CTLGRP=G4&CTLFNC=save";
			...
			if(data.RTN_DATA.IMG){
				...
				if(data.RTN_DATA.IMG && tArray1.length > 0){
					for(var t=0;t<tArray1.length;t++){
						...
						$("#G4-IMG-HOLDER").append("<span><a href='" + tArray2[0] + "' target='_blank'><img src='" + tArray2[1] + "' height='80' border=0></a></span>"); 						
					}
				}
			}
