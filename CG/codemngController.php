...
$REQ["G1-MYCHECK"] = reqPostString("G1-MYCHECK",11);//체크	
$REQ["G1-MYCHECK"] = getFilter($REQ["G1-MYCHECK"],"CLEARTEXT","/--미 정의--/");	
...
//G4, 상세폼
$REQ["G4-MYCHECK"] = reqPostString("G4-MYCHECK",11);//체크	
$REQ["G4-MYCHECK"] = getFilter($REQ["G4-MYCHECK"],"CLEARTEXT","/--미 정의--/");	
