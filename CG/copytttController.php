...
include_once('copytttService.php');
...
alog("CopytttControl___________________________start");
...
}else if($objAuth->isAuth("COPYTTT",$ctl)){
	$objAuth->LAUTH_SEQ = $objAuth->logUsrAuth($reqToken,$resToken,"COPYTTT",$ctl,"Y");
}else{
	$objAuth->logUsrAuth($reqToken,$resToken,"COPYTTT",$ctl,"N");
...
alog("CopytttControl___________________________end");
