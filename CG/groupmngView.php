...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->	<!--
	...
	<!--GRP_SEQ오브젝트출력-->						<input type="text" name="G1-GRP_SEQ" value="<?=getFilter(reqPostString("GRP_SEQ",30),"SAFEECHO","")?>" id="G1-GRP_SEQ" style="width:px;">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : GRP_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:px;"-->
					<div class="CON_OBJECT">
	<!--GRP_NM오브젝트출력-->						<input type="text" name="G1-GRP_NM" value="<?=getFilter(reqPostString("GRP_NM",30),"SAFEECHO","")?>" id="G1-GRP_NM" style="width:px;">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
...
<input type="button" name="BTN_G2_CHKSAVE" value="선택저장" onclick="G2_CHKSAVE(uuidv4());">
    ...
    <div class="GRP_OBJECT" style="width:50%;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
            <div class="GRP_INNER" style="height:284px;">
		...
		<div style="height:262px;" class="FORMVIEW_OBJECT">
			<DIV class="CON_LINE" is_br_tag>
			<!--OBJECT LIST PRINT.-->
			</DIV><!--is_br_tab end-->
		</div>
