...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--SVCGRPID오브젝트출력-->						<input type="text" name="G1-SVCGRPID" value="<?=getFilter(reqPostString("SVCGRPID",30),"SAFEECHO","")?>" id="G1-SVCGRPID" style="width:70px;" class="">
					</div>
				</div>
					<!-- FNCSEQ -->
	...
	<!--FNCSEQ오브젝트출력-->						<input type="text" name="G3-FNCSEQ" value="" id="G3-FNCSEQ" style="width:60px;" class="">
			...
			<!--I.COLID : SVCGRPID-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:70px;"-->
					<div class="CON_OBJECT">
	<!--SVCGRPID오브젝트출력-->						<input type="text" name="G3-SVCGRPID" value="" id="G3-SVCGRPID" style="width:70px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
