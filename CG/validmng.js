//글로벌 변수 선언	
//버틀 그룹쪽에서 컨틀롤러 호출
var url_C1_SEARCHALL = "validmngController?CTLGRP=C1&CTLFNC=SEARCHALL";//버틀 그룹쪽에서 컨틀롤러 호출
var url_C1_SAVE = "validmngController?CTLGRP=C1&CTLFNC=SAVE";//버틀 그룹쪽에서 컨틀롤러 호출
var url_C1_RESET = "validmngController?CTLGRP=C1&CTLFNC=RESET";//조회조건 변수 선언	
...
//컨트롤러 경로
var url_G2_HIDDENCOL = "validmngController?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "validmngController?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "validmngController?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
...
function F3_RELOAD(){
	...
	F3_SEARCH(lastinputF3json,token);
}//F3_SAVE
//IO_FILE_YN = N	
