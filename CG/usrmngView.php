	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
            <div class="GRP_INNER" style="height:48px;">	
		...
		<div style="height:26px;border-radius:3px;-moz-border-radius: 3px;" class="CONDITION_OBJECT">
...
<input type="button" name="BTN_G2_SAVEPWD" value="비번변경" onclick="G2_SAVEPWD(uuidv4());">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG2"  style="background-color:white;overflow:hidden;height:365px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
