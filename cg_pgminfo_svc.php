...
class cg_pgminfo_svc 
{
	...
	*/
	...
	public function goGrpSave(){
		...
		$grpId="GRP";
		$GRID["XML"]=$REQ[$grpId."-XML"];
		$GRID["COLORD"] = "PJTSEQ,PGMSEQ,GRPSEQ,GRPID,GRPTYPE,GRPNM,GRPORD,FREEZECNT,REFGRPID,VBOX,GRPWIDTH,GRPHEIGHT,COLSIZETYPE,LEGENDALIGN,STACKED,PROPERTY,METHOD,ADDDT,MODDT"; //그리드 컬럼순서(Hidden컬럼포함)
		//암호화컬럼
		$GRID["COLCRYPT"] = array();	
